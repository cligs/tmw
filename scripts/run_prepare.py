...
infolder = join(wdir, "/home/ulrike/Dokumente/Rostock/Lehre/SS_22/Kempowski/Korpus/ann_in")
outfolder = join(wdir, "/home/ulrike/Dokumente/Rostock/Lehre/SS_22/Kempowski/Korpus/ann_out")
...
inpath = join(wdir, "data/letters-leipzig_tagged", "*.trt")
outfolder = join(wdir, "data/letters-leipzig_lemmata_NNE")
mode = "deNNE"
